...
export default React.memo(() => {
    ...
    return (
        <View style={{ flexGrow: 1, backgroundColor: Theme.background, justifyContent: 'center', paddingHorizontal: 32, paddingTop: safeArea.top, paddingBottom: safeArea.bottom }}>
            ...
            <Text style={{ color: Theme.text, fontSize: 32, alignSelf: 'center', textAlign: 'center' }}>Be honest</Text>
            <Text style={{ color: Theme.text, fontSize: 20, alignSelf: 'center', textAlign: 'center', marginTop: 32, marginBottom: 32 }}>Please, be honest with your reviews. This is for you and your friends, not for some internet randos.</Text>
            {layout === 'small' && (
                <View style={{ flexGrow: 1 }} />
            )}
